...
export const TABLE_COLUMNS: Record<string, string[]> = {
  ...
  // VIEWS - Tablas virtuales con JOINs precalculados
  conductores_info: ['id', 'trabajador_id', 'nombres', 'apellidos', 'email', 'telefono', 'estado', 'experiencia_anios'],
  vehiculos_info: ['id', 'placa', 'marca', 'modelo', 'anio', 'tipo', 'capacidad', 'estado', 'kilometraje', 'soat_vence', 'tecno_vence'],
  rutas_info: ['id', 'codigo', 'nombre', 'origen', 'destino', 'distancia_km', 'duracion_min', 'activa'],
  despachos_info: ['id', 'fecha', 'hora_real_salida', 'hora_real_llegada', 'estado', 'conductor_id', 'conductor_nombre', 'vehiculo_placa', 'observaciones'],
  pagos_info: ['id', 'monto', 'metodo', 'estado', 'pagado_en', 'tiquete_codigo', 'tiquete_precio'],
};
